...
func GetPublicQuestionListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetPublicQuestionListReq
		...
		l := question.NewGetPublicQuestionListLogic(r.Context(), svcCtx)
		resp, err := l.GetPublicQuestionList(&req)
		// if err != nil {
		// 	httpx.ErrorCtx(r.Context(), w, err)
		// } else {
