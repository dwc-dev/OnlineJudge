...
func GetQuestionBasicInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetQuestionBasicInfoReq
		...
		l := question.NewGetQuestionBasicInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetQuestionBasicInfo(&req)
		// if err != nil {
		// 	httpx.ErrorCtx(r.Context(), w, err)
		// } else {
