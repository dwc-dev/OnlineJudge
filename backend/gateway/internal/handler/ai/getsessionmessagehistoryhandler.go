...
func GetSessionMessageHistoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSessionMessageHistoryReq
		...
		URL := fmt.Sprintf("%s/session/chat/history", svcCtx.Config.AIServiceURL)
