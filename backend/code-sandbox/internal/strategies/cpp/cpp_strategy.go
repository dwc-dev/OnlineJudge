...
func NewCppStrategy(code string, inputList []string) *CppStrategy {
	return &CppStrategy{code: code, inputList: inputList}
}

func (s *CppStrategy) Prepare() error {
	var err error
...
func (s *CppStrategy) Compile() error {
...
func (s *CppStrategy) Execute() ([]types.ExecResult, error) {
